...
interface IRuntimeObjects {
	['XpEntity']: IObjectClass<IXpEntity>;
	['TitleTilemap']: IObjectClass<ITitleTilemap>;
	['TitleText']: IObjectClass<ITitleText>;
	['Text']: IObjectClass<IText>;
	['StartGameText']: IObjectClass<IStartGameText>;
	['StageNumberText']: IObjectClass<IStageNumberText>;
	['SkyBkg']: IObjectClass<ISkyBkg>;
	['ShopText']: IObjectClass<IShopText>;
	['SettingsInfoText']: IObjectClass<ISettingsInfoText>;
	['ReturnTitleText']: IObjectClass<IReturnTitleText>;
	['PlayerPortal']: IObjectClass<IPlayerPortal>;
	['MouseEntity']: IObjectClass<IMouseEntity>;
	['MenuBkg']: IObjectClass<IMenuBkg>;
	['LocalStorage']: IObjectClass<ILocalStorage>;
	['Keyboard']: IObjectClass<IKeyboard>;
	['Hitbox']: IObjectClass<IHitbox>;
	['HeroFrame']: IObjectClass<IHeroFrame>;
	['GameTilemap']: IObjectClass<IGameTilemap>;
	['GameOverText']: IObjectClass<IGameOverText>;
	['Frame']: IObjectClass<IFrame>;
	['Entity']: IObjectClass<IEntity>;
	['EnemyPortal']: IObjectClass<IEnemyPortal>;
	['CustomButtonEntity']: IObjectClass<ICustomButtonEntity>;
	['CoinText']: IObjectClass<ICoinText>;
	['CoinEntity']: IObjectClass<ICoinEntity>;
	['Cloud']: IObjectClass<ICloud>;
...
interface IXpEntityVars extends VariableType {
	
}
interface IXpEntityBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IXpEntity extends ISpriteInstance {
	instVars: IXpEntityVars;
	behaviors: IXpEntityBehaviors;
}

interface ITitleTilemapVars extends VariableType {
	
}
interface ITitleTilemapBehaviors extends Record<string, IBehaviorInstance> {
	['Solid']: IBehaviorInstance
}
interface ITitleTilemap extends ITilemapInstance {
	instVars: ITitleTilemapVars;
	behaviors: ITitleTilemapBehaviors;
}

interface ITitleTextVars extends VariableType {
	
}
interface ITitleTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ITitleText extends ITextInstance {
	instVars: ITitleTextVars;
	behaviors: ITitleTextBehaviors;
}
...
interface IStartGameTextVars extends VariableType {
	
}
interface IStartGameTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IStartGameText extends ITextInstance {
	instVars: IStartGameTextVars;
	behaviors: IStartGameTextBehaviors;
}

interface IStageNumberTextVars extends VariableType {
	
}
interface IStageNumberTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IStageNumberText extends ITextInstance {
	instVars: IStageNumberTextVars;
	behaviors: IStageNumberTextBehaviors;
}

interface ISkyBkgVars extends VariableType {
	
}
interface ISkyBkgBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ISkyBkg extends IWorldInstance {
	instVars: ISkyBkgVars;
	behaviors: ISkyBkgBehaviors;
}

interface IShopTextVars extends VariableType {
	
}
interface IShopTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IShopText extends ITextInstance {
	instVars: IShopTextVars;
	behaviors: IShopTextBehaviors;
}

interface ISettingsInfoTextVars extends VariableType {
	
}
interface ISettingsInfoTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ISettingsInfoText extends ITextInstance {
	instVars: ISettingsInfoTextVars;
	behaviors: ISettingsInfoTextBehaviors;
}

interface IReturnTitleTextVars extends VariableType {
	
}
interface IReturnTitleTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IReturnTitleText extends ITextInstance {
	instVars: IReturnTitleTextVars;
	behaviors: IReturnTitleTextBehaviors;
}

interface IPlayerPortalVars extends VariableType {
	
}
interface IPlayerPortalBehaviors extends Record<string, IBehaviorInstance> {
	['Rotate']: IBehaviorInstance
}
interface IPlayerPortal extends IWorldInstance {
	instVars: IPlayerPortalVars;
	behaviors: IPlayerPortalBehaviors;
}

interface IMouseEntityVars extends VariableType {
	
}
interface IMouseEntityBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IMouseEntity extends ISpriteInstance {
	instVars: IMouseEntityVars;
	behaviors: IMouseEntityBehaviors;
}

interface IMenuBkgVars extends VariableType {
	
}
interface IMenuBkgBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IMenuBkg extends IWorldInstance {
	instVars: IMenuBkgVars;
	behaviors: IMenuBkgBehaviors;
}
...
interface IHitboxVars extends VariableType {
	
}
interface IHitboxBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IHitbox extends ISpriteInstance {
	instVars: IHitboxVars;
	behaviors: IHitboxBehaviors;
}

interface IHeroFrameVars extends VariableType {
	
}
interface IHeroFrameBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IHeroFrame extends ISpriteInstance {
	instVars: IHeroFrameVars;
	behaviors: IHeroFrameBehaviors;
}

interface IGameTilemapVars extends VariableType {
	
}
interface IGameTilemapBehaviors extends Record<string, IBehaviorInstance> {
	['Solid']: IBehaviorInstance
}
interface IGameTilemap extends ITilemapInstance {
	instVars: IGameTilemapVars;
	behaviors: IGameTilemapBehaviors;
}

interface IGameOverTextVars extends VariableType {
	
}
interface IGameOverTextBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IGameOverText extends ITextInstance {
	instVars: IGameOverTextVars;
	behaviors: IGameOverTextBehaviors;
}

interface IFrameVars extends VariableType {
	
}
interface IFrameBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IFrame extends ISpriteInstance {
	instVars: IFrameVars;
	behaviors: IFrameBehaviors;
}

interface IEntityVars extends VariableType {
	
}
interface IEntityBehaviors extends Record<string, IBehaviorInstance> {
	['Platform']: IPlatformBehaviorInstance
}
interface IEntity extends ISpriteInstance {
	instVars: IEntityVars;
	behaviors: IEntityBehaviors;
}

interface IEnemyPortalVars extends VariableType {
	
}
interface IEnemyPortalBehaviors extends Record<string, IBehaviorInstance> {
	['Rotate']: IBehaviorInstance
}
interface IEnemyPortal extends IWorldInstance {
	instVars: IEnemyPortalVars;
	behaviors: IEnemyPortalBehaviors;
}

interface ICustomButtonEntityVars extends VariableType {
	
}
interface ICustomButtonEntityBehaviors extends Record<string, IBehaviorInstance> {
	['Anchor']: IBehaviorInstance
	['Pin']: IBehaviorInstance
}
interface ICustomButtonEntity extends ISpriteInstance {
	instVars: ICustomButtonEntityVars;
	behaviors: ICustomButtonEntityBehaviors;
}

interface ICoinTextVars extends VariableType {
	
}
interface ICoinTextBehaviors extends Record<string, IBehaviorInstance> {
	['Anchor']: IBehaviorInstance
}
interface ICoinText extends ITextInstance {
	instVars: ICoinTextVars;
	behaviors: ICoinTextBehaviors;
}

interface ICoinEntityVars extends VariableType {
	
}
interface ICoinEntityBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ICoinEntity extends ISpriteInstance {
	instVars: ICoinEntityVars;
	behaviors: ICoinEntityBehaviors;
}

interface ICloudVars extends VariableType {
	
}
interface ICloudBehaviors extends Record<string, IBehaviorInstance> {
	['Bullet']: IBulletBehaviorInstance
	['Wrap']: IBehaviorInstance
}
interface ICloud extends ISpriteInstance {
	instVars: ICloudVars;
	behaviors: ICloudBehaviors;
}
