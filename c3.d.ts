...
interface IRuntimeObjects {
	...
	['HeroEntity']: IObjectClass<IHeroEntity>;
	['Entity']: IObjectClass<IEntity>;
	['EnemyEntity']: IObjectClass<IEnemyEntity>;
	['CustomButton']: IObjectClass<ICustomButton>;
...
interface IHeroEntityVars extends VariableType {
	
}
interface IHeroEntityBehaviors extends Record<string, IBehaviorInstance> {
	['Solid']: IBehaviorInstance
}
interface IHeroEntity extends ISpriteInstance {
	instVars: IHeroEntityVars;
	behaviors: IHeroEntityBehaviors;
}
...
interface IEnemyEntityVars extends VariableType {
	
}
interface IEnemyEntityBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IEnemyEntity extends ISpriteInstance {
	instVars: IEnemyEntityVars;
	behaviors: IEnemyEntityBehaviors;
}

interface ICustomButtonVars extends VariableType {
	
}
interface ICustomButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ICustomButton extends ISpriteInstance {
	instVars: ICustomButtonVars;
	behaviors: ICustomButtonBehaviors;
}
